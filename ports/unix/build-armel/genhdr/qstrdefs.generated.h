...
QDEF(MP_QSTR__date, (const byte*)"\xee\x76\x05" "_date")
QDEF(MP_QSTR__git, (const byte*)"\x60\x33\x04" "_git")
...
QDEF(MP_QSTR_fll_test, (const byte*)"\x4a\x7f\x08" "fll_test")
QDEF(MP_QSTR_fllengine, (const byte*)"\xcd\x7d\x09" "fllengine")
...
QDEF(MP_QSTR_hexversion, (const byte*)"\x2a\x60\x0a" "hexversion")
...
QDEF(MP_QSTR_major, (const byte*)"\x9e\xc5\x05" "major")
...
QDEF(MP_QSTR_releaselevel, (const byte*)"\x1a\x3f\x0c" "releaselevel")
...
QDEF(MP_QSTR_serial, (const byte*)"\x05\xe1\x06" "serial")
